...
(1, 'Event Management System', 'info@sample.comm', '+6948 8542 623', '1669126140_bg2.png', '&lt;p style=&quot;text-align: center; background: transparent; position: relative;&quot;&gt;&lt;span style=&quot;color: rgb(0, 0, 0); font-family: &amp;quot;Open Sans&amp;quot;, Arial, sans-serif; font-weight: 400; text-align: justify;&quot;&gt;&amp;nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&rsquo;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.&lt;/span&gt;&lt;br&gt;&lt;/p&gt;&lt;p style=&quot;text-align: center; background: transparent; position: relative;&quot;&gt;&lt;br&gt;&lt;/p&gt;&lt;p style=&quot;text-align: center; background: transparent; position: relative;&quot;&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;&lt;/p&gt;'); */
...
(2, 'ESS', 'Jalkot Road ,udgir', 'siddiqui@viit.ac.in', '1234567890', 1, '5', '2022-11-22 19:35:00', 1),
(3, 'Ehteshamoddin Siddiqui', 'Jalkot Road ,udgir', 'sigmageekes@gmail.com', '9561198426', 2, '5', '2022-11-24 11:09:00', 1);
...
CREATE TRIGGER `insertlog` BEFORE INSERT ON `events` FOR EACH ROW INSERT INTO logs VALUES(null,NEW.venue_id,'Inserted',NOW());


CREATE TRIGGER `deleteLog` BEFORE DELETE ON `events` FOR EACH ROW INSERT INTO logs VALUES(null,OLD.venue_id,'Deleted',NOW());


CREATE TRIGGER `updateLog` BEFORE UPDATE ON `events` FOR EACH ROW INSERT INTO logs VALUES(null,NEW.venue_id,'Updated',NOW());

-- creating stored procedures
CREATE PROCEDURE `getEvents`(IN `venue_id` INT) NOT DETERMINISTIC CONTAINS SQL SQL SECURITY DEFINER SELECT *FROM events;

--call for stored procedures
SET @p0=CHAR('10'); CALL `getEvents`(@p0);